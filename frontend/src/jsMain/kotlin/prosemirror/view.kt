...
import org.w3c.dom.ClipboardEvent
import org.w3c.dom.DragEvent
import org.w3c.dom.Document
import org.w3c.dom.Event
import org.w3c.dom.HTMLElement
import org.w3c.dom.MouseEvent
import org.w3c.dom.ShadowRoot
import org.w3c.dom.events.KeyboardEvent
import org.w3c.dom.mutations.MutationRecord
import prosemirror.model.DOMParser
import prosemirror.model.DOMSerializer
import prosemirror.model.Mark
import prosemirror.model.Node as ProsemirrorNode
...
import prosemirror.transform.Mapping
...
typealias WidgetConstructor = dynamic
/**
Decoration objects can be provided to the view through the
[`decorations` prop](https://prosemirror.net/docs/ref/#view.EditorProps.decorations). They come in
several variants—see the static members of this class for details.
*/
external open class Decoration {
    /**
    ...
    */
    ...
    companion object {
        ...
        */
        fun widget(pos: Double, toDOM: WidgetConstructor, spec: DecorationWidgetSpec? = definedExternally): Decoration
        /**
        Creates an inline decoration, which adds the given attributes to
        each inline node between `from` and `to`.
        */
        fun inline(from: Double, to: Double, attrs: DecorationAttrs, spec: DecorationInlineSpec? = definedExternally): Decoration
        /**
        Creates a node decoration. `from` and `to` should point precisely
        before and after a node in the document. That node, and only that
        node, will receive the given attributes.
        */
        fun node(from: Double, to: Double, attrs: DecorationAttrs, spec: Any? = definedExternally): Decoration
    }
...
*/
external interface DecorationAttrs {
    /**
...
*/
external interface DecorationSource {
    /**
    Map the set of decorations in response to a change in the
    document.
    */
    fun map(mapping: Mapping, node: ProsemirrorNode): DecorationSource
    /**
    Extract a DecorationSource containing decorations for the given child node at the given offset.
    */
    fun forChild(offset: Double, child: ProsemirrorNode): DecorationSource
    /**
    Call the given function for each decoration set in the group.
    */
    fun forEachSet(f: (set: DecorationSet) -> Unit): Unit
}
/**
...
*/
external open class DecorationSet : DecorationSource {
    /**
    ...
    */
    companion object {
        fun create(doc: ProsemirrorNode, decorations: Array<Decoration>): DecorationSet
        /**
        The empty set of decorations.
        */
        val empty: DecorationSet
    }
    /**
    ...
    assumed to match.
    */
    fun find(start: Double? = definedExternally, end: Double? = definedExternally, predicate: ((spec: Any?) -> Boolean)? = definedExternally): Array<Decoration>
    private var findInner: dynamic
    /**
    Map the set of decorations in response to a change in the
    document.
    */
    fun map(mapping: Mapping, doc: ProsemirrorNode, options: DecorationSetMapOptions? = definedExternally): DecorationSet
    /**
    ...
    structure.
    */
    fun add(doc: ProsemirrorNode, decorations: Array<Decoration>): DecorationSet
    private var addInner: dynamic
    /**
    Create a new set that contains the decorations in this set, minus
    the ones in the given array.
    */
    fun remove(decorations: Array<Decoration>): DecorationSet
    private var removeInner: dynamic
    override fun forChild(offset: Double, child: ProsemirrorNode): DecorationSource
    override fun forEachSet(f: (set: DecorationSet) -> Unit): Unit
    override fun map(mapping: Mapping, node: ProsemirrorNode): DecorationSource
}
external open class DecorationGroup : DecorationSource {
    val members: ReadonlyArray<DecorationSet>
    constructor(members: ReadonlyArray<DecorationSet>)
    override fun map(mapping: Mapping, node: ProsemirrorNode): DecorationSource
    override fun forChild(offset: Double, child: ProsemirrorNode): DecorationSource
    fun eq(other: DecorationGroup): Boolean
    fun locals(node: ProsemirrorNode): ReadonlyArray<Any?>

    companion object {
        fun from(members: ReadonlyArray<DecorationSource>): DecorationSource
    }
...
*/
typealias ViewMutationRecord = dynamic
/**
...
external interface NodeView {
    ...
    */
    var update: ((node: ProsemirrorNode, decorations: ReadonlyArray<Decoration>, innerDecorations: DecorationSource) -> Boolean)?
    /**
    ...
    */
    var setSelection: ((anchor: Double, head: Double, root: dynamic) -> Unit)?
    /**
    Can be used to prevent the editor view from trying to handle some
    or all DOM events that bubble up from the node view. Events for
    which this returns true are not handled by the editor.
    */
    var stopEvent: ((event: Event) -> Boolean)?
    /**
    ...
    */
    var ignoreMutation: ((mutation: ViewMutationRecord) -> Boolean)?
    /**
...
*/
external open class EditorView {
    private var directPlugins: dynamic
    private var _root: dynamic
    private var mounted: dynamic
    private var prevDirectPlugins: dynamic
    private var pluginViews: dynamic
    /**
    ...
    */
    constructor(place: dynamic, props: DirectEditorProps)
    /**
    ...
    */
    val props: DirectEditorProps
    /**
    Update the view's props. Will immediately cause an update to
    the DOM.
    */
    fun update(props: DirectEditorProps): Unit
    /**
    Update the view by updating existing props object with the object
    given as argument. Equivalent to `view.update(Object.assign({},
    view.props, props))`.
    */
    fun setProps(props: dynamic): Unit
    /**
    Update the editor's `state` prop, without touching any of the
    other props.
    */
    fun updateState(state: EditorState): Unit
    private var updateStateInner: dynamic
    private var destroyPluginViews: dynamic
    private var updatePluginViews: dynamic
    private var updateDraggedNode: dynamic
    /**
    ...
    */
    fun <Result> someProp(propName: String, f: (value: Any) -> Result): Result?
    fun someProp(propName: String): Any?
    /**
    ...
    */
    fun posAtCoords(coords: ViewCoords): PosAtCoordsResult?
    /**
    ...
    */
    fun coordsAtPos(pos: Double, side: Double? = definedExternally): CoordsAtPosResult
    /**
    ...
    */
    fun domAtPos(pos: Double, side: Double? = definedExternally): DomAtPosResult
    /**
    ...
    */
    fun nodeDOM(pos: Double): DOMNode?
    /**
    ...
    */
    fun posAtDOM(node: DOMNode, offset: Double, bias: Double? = definedExternally): Double
    /**
    ...
    */
    fun endOfTextblock(dir: String, state: EditorState? = definedExternally): Boolean
    /**
    Run the editor's paste logic with the given HTML string. The
    `event`, if given, will be passed to the
    [`handlePaste`](https://prosemirror.net/docs/ref/#view.EditorProps.handlePaste) hook.
    */
    fun pasteHTML(html: String, event: ClipboardEvent? = definedExternally): Boolean
    /**
    Run the editor's paste logic with the given plain-text input.
    */
    fun pasteText(text: String, event: ClipboardEvent? = definedExternally): Boolean
    /**
    ...
    */
    fun serializeForClipboard(slice: Slice): SerializeForClipboardResult
    /**
    ...
    */
    ...
    Used for testing.
    */
    fun dispatchEvent(event: Event): Unit
    /**
...
*/
typealias NodeViewConstructor = (node: ProsemirrorNode, view: EditorView, getPos: () -> Double?, decorations: ReadonlyArray<Decoration>, innerDecorations: DecorationSource) -> NodeView
/**
The function types [used](https://prosemirror.net/docs/ref/#view.EditorProps.markViews) to create
mark views.
*/
typealias MarkViewConstructor = (mark: Mark, view: EditorView, inline: Boolean) -> MarkView
/**
...
external interface DOMEventMap {
    @nativeGetter
    operator fun get(event: String): Any?

    @nativeSetter
    operator fun set(event: String, value: Any?)
}
/**
...
*/
external interface EditorProps<P> {
    /**
    ...
    default behavior).
    */
    var handleDOMEvents: DOMEventHandlers<P>?
    /**
    Called when the editor receives a `keydown` event.
    */
    var handleKeyDown: ((view: EditorView, event: KeyboardEvent) -> Any?)?
    /**
    Handler for `keypress` events.
    */
    var handleKeyPress: ((view: EditorView, event: KeyboardEvent) -> Any?)?
    /**
    Whenever the user directly input text, this handler is called
    before the input is applied. If it returns `true`, the default
    behavior of actually inserting the text is suppressed.
    */
    var handleTextInput: ((view: EditorView, from: Double, to: Double, text: String, deflt: () -> Transaction) -> Any?)?
    /**
    Called for each node around a click, from the inside out. The
    `direct` flag will be true for the inner node.
    */
    var handleClickOn: ((view: EditorView, pos: Double, node: ProsemirrorNode, nodePos: Double, event: MouseEvent, direct: Boolean) -> Any?)?
    /**
    Called when the editor is clicked, after `handleClickOn` handlers
    have been called.
    */
    var handleClick: ((view: EditorView, pos: Double, event: MouseEvent) -> Any?)?
    /**
    Called for each node around a double click.
    */
    var handleDoubleClickOn: ((view: EditorView, pos: Double, node: ProsemirrorNode, nodePos: Double, event: MouseEvent, direct: Boolean) -> Any?)?
    /**
    Called when the editor is double-clicked, after `handleDoubleClickOn`.
    */
    var handleDoubleClick: ((view: EditorView, pos: Double, event: MouseEvent) -> Any?)?
    /**
    Called for each node around a triple click.
    */
    var handleTripleClickOn: ((view: EditorView, pos: Double, node: ProsemirrorNode, nodePos: Double, event: MouseEvent, direct: Boolean) -> Any?)?
    /**
    Called when the editor is triple-clicked, after `handleTripleClickOn`.
    */
    var handleTripleClick: ((view: EditorView, pos: Double, event: MouseEvent) -> Any?)?
    /**
    Can be used to override the behavior of pasting. `slice` is the
    pasted content parsed by the editor, but you can directly access
    the event to get at the raw content.
    */
    var handlePaste: ((view: EditorView, event: ClipboardEvent, slice: Slice) -> Any?)?
    /**
    Called when something is dropped on the editor. `moved` will be
    true if this drop moves from the current selection (which should
    thus be deleted).
    */
    var handleDrop: ((view: EditorView, event: DragEvent, slice: Slice, moved: Boolean) -> Any?)?
    /**
    ...
    */
    var handleScrollToSelection: ((view: EditorView) -> Boolean)?
    /**
    ...
    */
    var dragCopies: ((event: DragEvent) -> Boolean)?
    /**
    Can be used to override the way a selection is created when
    reading a DOM selection between the given anchor and head.
    */
    var createSelectionBetween: ((view: EditorView, anchor: ResolvedPos, head: ResolvedPos) -> Selection?)?
    /**
    ...
    */
    var transformPastedHTML: ((html: String, view: EditorView) -> String)?
    /**
    ...
    */
    var clipboardParser: DOMParser?
    /**
    Transform pasted plain text. The `plain` flag will be true when
    the text is pasted as plain text.
    */
    var transformPastedText: ((text: String, plain: Boolean, view: EditorView) -> String)?
    /**
    ...
    */
    var clipboardTextParser: ((text: String, `$context`: ResolvedPos, plain: Boolean, view: EditorView) -> Slice)?
    /**
    ...
    */
    var transformPasted: ((slice: Slice, view: EditorView, plain: Boolean) -> Slice)?
    /**
    Can be used to transform copied or cut content before it is
    serialized to the clipboard.
    */
    var transformCopied: ((slice: Slice, view: EditorView) -> Slice)?
    /**
    ...
    */
    var clipboardSerializer: DOMSerializer?
    /**
    ...
    selected range.
    */
    var clipboardTextSerializer: ((content: Slice, view: EditorView) -> String)?
    /**
    A set of [document decorations](https://prosemirror.net/docs/ref/#view.Decoration) to show in the
    view.
    */
    var decorations: ((state: EditorState) -> DecorationSource?)?
    /**
    ...
    */
    var scrollThreshold: dynamic
    /**
    Determines the extra space (in pixels) that is left above or
    below the cursor when it is scrolled into view. Defaults to 5.
    */
    var scrollMargin: dynamic
}
/**
The props object given directly to the editor view supports some
fields that can't be used in plugins:
*/
external interface DirectEditorProps : EditorProps<Any?> {
    /**
...
external interface DecorationWidgetSpec {
    /**
...
external interface DecorationInlineSpec {
    /**
...
external interface DecorationSetMapOptions {
    /**
    When given, this function will be called for each decoration
    that gets dropped as a result of the mapping, passing the
    spec of that decoration.
    */
    var onRemove: ((decorationSpec: Any?) -> Unit)?
}

external interface Dragging {
    var slice: Slice
    var move: Boolean
}

external interface ViewCoords {
    var left: Double
    var top: Double
}

external interface PosAtCoordsResult {
    var pos: Double
    var inside: Double
}

external interface CoordsAtPosResult {
    var left: Double
    var right: Double
    var top: Double
    var bottom: Double
...
external interface DomAtPosResult {
    var node: DOMNode
    var offset: Double
}

external interface SerializeForClipboardResult {
    var dom: HTMLElement
    var text: String
    var slice: Slice
}

external interface DOMEventHandlers<P> {
    @nativeGetter
    operator fun get(event: String): ((view: EditorView, event: Any?) -> Any?)?

    @nativeSetter
    operator fun set(event: String, value: (view: EditorView, event: Any?) -> Any?)
}

external interface NodeViewMap {
    @nativeGetter
    operator fun get(node: String): NodeViewConstructor?

    @nativeSetter
    operator fun set(node: String, value: NodeViewConstructor)
}

external interface MarkViewMap {
    @nativeGetter
    operator fun get(mark: String): MarkViewConstructor?

    @nativeSetter
    operator fun set(mark: String, value: MarkViewConstructor)
}
